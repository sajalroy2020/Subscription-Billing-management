...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('user/images/logo-black.png') }}" type="image/x-icon">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <div class="breadcrumb-text">
                        <a class="brand-logo" href="#"><img src="{{ asset('user/images/logo-black.png') }}" alt="logo"></a>

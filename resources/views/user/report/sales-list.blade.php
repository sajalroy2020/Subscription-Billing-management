    ...
    <div class="px-24 pb-24 position-relative">
        ...
        <div class="p-20 bd-one bd-c-stroke-color bd-ra-12 bg-white overflow-hidden">
            <div id="customersTable_wrapper" class="dataTables_wrapper no-footer">
                <table class="table zTable zTable-last-item-right dataTable no-footer dtr-inline" id="salesListDataTable"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1">
                                <div class="min-sm-w-100">{{ __('Product') }}</div>
                            </th>
                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1">
                            ...
                            <th scope="col" class="sorting_disabled" rowspan="1" colspan="1">
                                <div class="min-sm-w-100">{{ __('Total') }}</div>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <input type="hidden" value="{{ route('user.report.sales.list') }}" id="report-sales-list-route">
    @endsection
    @push('script')

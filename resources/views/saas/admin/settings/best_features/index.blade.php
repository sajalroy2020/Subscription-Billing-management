                ...
                <div class="col-xxl-10 col-lg-9 col-md-8">
                    <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                        <div
                            ...
                            <input type="hidden" id="best_features_setting" value="{{ route('admin.frontend-setting.best-features.index') }}">
                            <div class="table-responsive zTable-responsive">
                                <table class="table zTable" id="bestFeaturesDataTable">
                                    <thead>
                                        <tr>
                                            <th>
                                                <div>{{ __('Image') }}</div>
    ...
    <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax reset" action="{{ route('admin.frontend-setting.best-features.store') }}" method="post"
                    ...
                    <div class="modal-footer border-0 pt-0">
                        <button type="submit" class="m-0 fs-15 border-0 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12">{{ __('Save') }}</button>
                    </div>
                </form>
            </div>
        </div>
...
@endsection
@push('script')
    <script src="{{asset('admin/custom/js/best_features_setting.js')}}"></script>
@endpush

...
@section('content')
                    ...
                    <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                        <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                            ...
                            <div class="d-flex flex-wrap item-title justify-content-between align-items-center mb-30">
                                <h4>{{ $pageTitle }}</h4>
                                <div>
                                    <button class="fs-15 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12 border-0"
                            ...
                            <div class="table-responsive zTable-responsive">
                                <table class="table zTable" id="featuresDataTable">
                                    <thead>
                                        <tr>
                                            <th>
                                                <div>{{ __('Image') }}</div>
    ...
    <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax reset" action="{{ route('admin.frontend-setting.features.store') }}" method="post"
                            ...
                            <div class="col-12">
                                <div class="primary-form-group">
                                    <div class="primary-form-group-wrap zImage-upload-details mw-100">
                                        ...
                                        <label for="zImageUpload" class="form-label">{{ __('Icon') }} <span
                                                class="text-danger">*</span></label>
                                        <div class="upload-img-box">
                                            <img src="" />
                    ...
                    <div class="modal-footer border-0 pt-0">
                        <button type="submit"
                            class="m-0 fs-15 border-0 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12">{{ __('Save') }}</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <input type="hidden" id="features_setting" value="{{ route('admin.frontend-setting.features.index') }}">
@endsection
@push('script')
    <script src="{{ asset('admin/custom/js/features_setting.js') }}"></script>
@endpush

            ...
            <div class="row bd-c-ebedf0 bd-half bd-ra-25 bg-white h-100 p-30">
                ...
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap gap-2 item-title justify-content-between mb-20">
                        <button type="button" class="border-0 fs-15 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12"
                            data-bs-toggle="modal" data-bs-target="#importModal" title="Import Keywords">
                            {{ __('Import Keywords') }}
                        </button>
                        <button type="button"
                            class="fs-15 fw-500 lh-25 text-white py-10 px-26 border-0 bg-7f56d9 bd-ra-12 addmore">
                            ...
                            <tbody id="append">
                                @foreach ($translators as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <button type="button"
                                                class="border-0 updateLangItem fs-15 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12">{{ __('Update') }}</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
            ...
            <div class="modal-content">
                <form class="ajax" action="{{ route('admin.setting.languages.import') }}" method="POST"
                    ...
                    <div class="modal-footer justify-content-start border-0 pt-0">
                        ...
                        <button type="submit"
                            class="border-0 updateLangItem fs-15 fw-500 lh-25 text-white py-10 px-26 bg-7f56d9 bd-ra-12"

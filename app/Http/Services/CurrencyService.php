...
class CurrencyService
{
            ...
            ->addColumn('action', function ($data){
                return '<ul class="d-flex align-items-center cg-5 justify-content-center">
                            <li class="d-flex gap-2">
                                ...
                                <button onclick="deleteItem(\'' . route('admin.setting.currencies.delete', $data->id) . '\', \'commonDataTable\')" class="d-flex justify-content-center align-items-center w-30 h-30 rounded-circle bd-one bd-c-ededed bg-white" title="Delete">
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $message = getMessage(__(CREATED_SUCCESSFULLY));
